  ...
  class Egg {
    ...
    update() {
      ...
      collisionObjects.forEach((object) => {
        let [collision, distance, sumObRadii, dx, dy] =
          this.game.checkCollision(this, object)
        if (collision) {
          const unit_x = dx / distance
          const unit_y = dy / distance
          this.collisionX = object.collisionX + (sumObRadii + 1) * unit_x
          this.collisionY = object.collisionY + (sumObRadii + 1) * unit_y
        }
      })
    }
  }
